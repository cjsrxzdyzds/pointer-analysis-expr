//! alias checking module for svf runtime.
//! contains __svf_check_alias and related statistics.
...
/// print alias analysis statistics.
pub fn print_alias_stats() {
    ...
    println!("  False Disjoint (False Negative): {}", f_disjoint);
